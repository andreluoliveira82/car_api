...
class Brand(Base):
    ...
    cars: Mapped[List['Car']] = relationship(
        'Car', back_populates='brand', cascade='all, delete-orphan', lazy='selectin'
    )
...
class Car(Base):
    ...
    # property relationships
    brand: Mapped[Brand] = relationship('Brand', back_populates='cars', lazy='selectin')
    owner: Mapped['User'] = relationship('User', back_populates='cars', lazy='selectin')
