...
class CarSchema(BaseModel):
    ...
    description: Optional[str] = Field(
        None, example='Carro confortável e seguro. Bom estado.'
    )
...
# ==============================================================================
# schemas para admin criar carros em nome de um usuario qualquer (quando necessario)
# ==============================================================================
class AdminCarCreateSchema(CarSchema):
    """
    Schema for administrators to create cars on behalf of a user.
    """

    owner_id: int = Field(..., example=3)


class AdminCarUpdateSchema(CarUpdateSchema):
    """
    Schema for administrators to update cars, including ownership.
    """
